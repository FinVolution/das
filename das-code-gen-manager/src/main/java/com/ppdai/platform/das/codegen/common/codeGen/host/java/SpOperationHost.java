...
public class SpOperationHost {
    ...
    public static SpOperationHost getSpaOperation(Long alldbs_id, String tableName, List<StoredProcedure> spNames,
        ...
        if (host.exist) {
            List<AbstractParameterHost> params = DbUtils.getSpParams(alldbs_id, currentSp,
                    new JavaSpParamResultSetExtractor(alldbs_id, currentSp.getName()));
