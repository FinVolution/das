package com.ppdai.platform.das.codegen.common.codeGen.host.java;

import com.ppdai.platform.das.codegen.common.codeGen.CodeGenConsts;
import com.ppdai.platform.das.codegen.common.codeGen.enums.ConditionType;
import com.ppdai.platform.das.codegen.common.codeGen.enums.DatabaseCategory;
import com.ppdai.platform.das.codegen.common.codeGen.enums.ParameterDirection;
import com.ppdai.platform.das.codegen.common.codeGen.host.AbstractParameterHost;
import com.ppdai.platform.das.codegen.enums.DataFieldTypeEnum;
...
public class JavaParameterHost extends AbstractParameterHost {
    ...
    private boolean isSqlDateExist;
    ...
    public String getClassDisplayName() {
        ...
        String rs = javaClass.getSimpleName();
        if (field_type == null) {
            return rs;
        }
        if (isSqlDateExist) {
            if (field_type != null && field_type == DataFieldTypeEnum.UTIL_DATE.getType() && DataFieldTypeEnum.SQL_TIMESTAMP.getDetail().equals(javaClass.getName())) {
                rs = DataFieldTypeEnum.UTIL_DATE.getDetail();
            }
        } else {
            if (field_type != null && field_type == DataFieldTypeEnum.UTIL_DATE.getType() && DataFieldTypeEnum.SQL_TIMESTAMP.getDetail().equals(javaClass.getName())) {
                rs = DataFieldTypeEnum.UTIL_DATE.getClassName();
            }
        }
        return rs;
    }
    ...
    public String getJavaTypeDisplay() {
        return CodeGenConsts.jdbcSqlTypeDisplay.get(this.sqlType);
    }

    public String getJDBCTypeDisplay() {
        return "JDBCType" + CodeGenConsts.jdbcSqlTypeDisplay.get(this.sqlType).replace("CheckTypes", "");
    }
    ...
    public boolean isSqlDateExist() {
        return isSqlDateExist;
    }

    public void setSqlDateExist(boolean sqlDateExist) {
        isSqlDateExist = sqlDateExist;
    }
}
