...
public class ResourceUtil {
    ...
    public boolean initializeDasSetXml() throws Exception {
        ...
        connectionLocator.addElement("settings").addElement("dataSourceConfigureProvider").addText("com.ppdai.platform.das.codegen.config.init.ConsoleDataSourceConfigureProvider");
