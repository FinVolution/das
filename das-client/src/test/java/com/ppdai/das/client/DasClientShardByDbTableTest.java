...
public class DasClientShardByDbTableTest extends DataPreparer {
    ...
    public DasClientShardByDbTableTest(DatabaseCategory dbCategory, ShardInfoProvider provider) throws SQLException {
        super(dbCategory);
        this.provider = provider;
    }
    
    public static DasClientShardByDbTableTest of(DatabaseCategory dbCategory) throws SQLException {
        return new DasClientShardByDbTableTest(dbCategory, new DefaultProvider());
    }
