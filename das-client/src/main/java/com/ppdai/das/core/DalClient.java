...
public interface DalClient {
	 ...
	 */
	<T> T query(String sql, List<Parameter> parameters, Hints hints,
	 ...
	 * @throws SQLException when things going wrong during the execution
	 */
	List<?> query(String sql, List<Parameter> parameters, Hints hints,
	 ...
	 * @throws SQLException when things going wrong during the execution
	 */
	int update(String sql, List<Parameter> parameters, Hints hints)
			throws SQLException;
	 ...
	 * @throws SQLException when things going wrong during the execution
	 */
	int[] batchUpdate(String[] sqls, Hints hints) throws SQLException;
	 ...
	 * @throws SQLException when things going wrong during the execution
	 */
	int[] batchUpdate(String sql, List<Parameter>[] parametersList,
	 ...
	 * @throws SQLException when things going wrong during the execution
	 */
	void execute(DalCommand command, Hints hints) throws SQLException;
	 ...
	 * @throws SQLException when things going wrong during the execution
	 */
	void execute(List<DalCommand> commands, Hints hints) throws SQLException;
	 ...
	 * @throws SQLException when things going wrong during the execution
	 */
	Map<String, ?> call(String callString, List<Parameter> parameters,
			Hints hints) throws SQLException;
	 ...
	 * @throws SQLException when things going wrong during the execution
	 */
	int[] batchCall(String callString, List<Parameter>[] parametersList,
			Hints hints) throws SQLException;
}
