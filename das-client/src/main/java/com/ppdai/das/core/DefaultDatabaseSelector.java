...
public class DefaultDatabaseSelector implements DatabaseSelector, DasComponent {
	...
	private String getAvailableDb(HaContext ha, List<DataBase> candidates) throws DalException{
	...
	private String getRandomRealDbName(HaContext ha, List<String> dbs) throws DalException{
